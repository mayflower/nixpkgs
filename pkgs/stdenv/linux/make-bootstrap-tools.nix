...
let
  ...
  patchelf = pkgs.patchelf.overrideAttrs(previousAttrs: {
    env =  (previousAttrs.env or {}) // {
      NIX_CFLAGS_COMPILE = (previousAttrs.env.NIX_CFLAGS_COMPILE or "") + " -static-libgcc -static-libstdc++";
      NIX_CFLAGS_LINK = (previousAttrs.env.NIX_CFLAGS_LINK or "") + " -static-libgcc -static-libstdc++";
    };
  });
in with pkgs; rec {
