      ...
      tokenjanitor = {
        ...
        interval = mkOption {
          ...
          description = ''
            ...
            <manvolnum>7</manvolnum></citerefentry> for further information.
          '';
        };
        action = mkOption {
        ...
        unassigned = mkOption {
          ...
          type = types.bool;
          description = ''
            Whether to search for <emphasis>unassigned</emphasis> tokens
            and apply <xref linkend="opt-services.privacyidea.tokenjanitor.action" />
            onto them.
          '';
        };
        orphaned = mkOption {
          ...
          type = types.bool;
          description = ''
            Whether to search for <emphasis>orphaned</emphasis> tokens
            and apply <xref linkend="opt-services.privacyidea.tokenjanitor.action" />
            onto them.
          '';
        };
